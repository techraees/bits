  ...
  return <div className="notification-wrapper" ref={modalRef}>
      ...
      {showModal && <div className="notification-dropdown">
          ...
          <div className="notification-body">
            {notifications.map(notification => <div key={notification.id} className="notification-item">
                <div className="notification-avatar">
                  {notification.name === "A" ? <div className="avatar-placeholder">
                      {notification.name}
                    </div> : <img src={notification.imageUrl} alt={notification.name} />}
                </div>
                <div className="notification-content">
                  <div className="notification-text">
                    ...
                    {notification.tag && <span className="notification-tag">
                        {notification.tag}
                      </span>}
