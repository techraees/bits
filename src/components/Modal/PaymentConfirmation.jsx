  ...
  return <>
      ...
      display: "block"
          ...
          borderRadius: "30px"
              ...
              <div className="modal-header flex-column">
                ...
                <div className="w-100 text-center">
                  <h5 className="modal-title fw-bold">
                    {paymentConfirm ? "Payment Confirmation" : "Download Confirmation"}
                  </h5>
                </div>
              </div>
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-md-11">
                    <p className="paymentConfirmationHeading">
                      {paymentConfirm ? "Congratulations! Your video is ready for download for free." : ""}
                      {downloadConfirm ? "Congratulations! You successfully downloaded your FBX file." : ""}
                    </p>
                  </div>
                </div>
              ...
              {paymentConfirm && <div className="modal-footer flex-column" style={{
            paddingLeft: 0,
            paddingRight: 0,
            borderTop: 0
          }}>
                  <button type="button" className="btn w-100 text-white checkoutBtn" onClick={handleDownloadClick}>
                    Download
                  </button>
                </div>}
            </div>
