        ...
        {isSwitchValue === ALLOWED_MARKET_PLACE_NFT_TYPE.FIXED_PRICE ? (
          <>
            <div className="d-flex align-items-center">
              <div
                className={` ${isFixedPriceStep === 1 ? "theme_gradient_red" : ""} popup_header_second_box`}
              >
                1
              </div>
            ...
            <div className="d-flex justify-content-center align-items-center">
              <div
                className={` ${isFixedPriceStep === 2 ? "theme_gradient_red" : ""} popup_header_second_box`}
              >
                2
              </div>
              <div>Quantity</div>
            ...
            <div className="d-flex justify-content-center align-items-center">
              <div
                className={` ${isFixedPriceStep === 3 ? "theme_gradient_red" : ""} popup_header_second_box`}
              >
                3
              </div>
              <div>Purchase</div>
          ...
          <>
            <div className="d-flex align-items-center">
              <div
                className={` ${isAuctionStep === 1 ? "theme_gradient_red" : ""} popup_header_second_box`}
              >
                1
              </div>
              <div className="">Listing</div>
            ...
            <div className="d-flex justify-content-center align-items-center">
              <div
                className={` ${isAuctionStep === 2 ? "theme_gradient_red" : ""} popup_header_second_box`}
              >
                2
              </div>
              <div>Auction</div>
