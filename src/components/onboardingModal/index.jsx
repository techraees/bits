...
// Shown once to first-time visitors (tracked via localStorage) so new users
// get a quick orientation instead of landing on the marketplace with no
// guidance on the creator/buyer flow.
const OnboardingModal = ({ visible, onClose }) => {
  ...
  return (
    <Modal
      style={{ marginTop: "4rem", zIndex: 999999999 }}
      footer={null}
