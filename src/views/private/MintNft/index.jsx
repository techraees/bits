...
const MintNft = () => {
  ...
  const { handleSubmit, handleBlur, setFieldValue, values, touched, errors } =
    useFormik({
      initialValues: {
        walletAddress: "",
        supply: 0,
      ...
      <div className="container py-3 mint-nft-page">
        ...
        <div className="mint-checklist mb-3">
          ...
          <ul className="mint-checklist__list">
            <li
              className={`mint-checklist__item ${isSupplyReady ? "mint-checklist__item--done" : ""}`}
            >
              <FaCheckCircle className="mint-checklist__icon" size={14} />
              <span>Circulating supply entered</span>
            </li>
            <li
              className={`mint-checklist__item ${isRoyaltyReady ? "mint-checklist__item--done" : ""}`}
            >
              <FaCheckCircle className="mint-checklist__icon" size={14} />
              <span>Royalty percentage set (0-100%)</span>
            </li>
            <li
              className={`mint-checklist__item ${isWalletReady ? "mint-checklist__item--done" : ""}`}
            >
              <FaCheckCircle className="mint-checklist__icon" size={14} />
