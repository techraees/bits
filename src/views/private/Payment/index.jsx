...
import { about2, about3, brown_layer, connect, metamask_tag, profile_large, white_layer } from "../../../assets";
  ...
  return <div className={`${backgroundTheme} pb-4`} style={{
    minHeight: "100vh"
      ...
      <div className="container">
        ...
        <div className={`my-4 ${bgColor3}`} style={{
        width: "100%",
        borderRadius: 20,
        display: "flex",
        justifyContent: "center"
          ...
          <div className="d-flex paymentCardsView">
            <div style={{
            background: "linear-gradient(180deg, #E57F25 0%, rgba(255, 186, 203, 0) 388.11%)",
            borderRadius: 20
