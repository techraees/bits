          ...
          <Col lg={14} sm={24} xs={24} className="borderBottom">
            ...
            >
              <Col lg={12} sm={24} md={12} xs={24}>
                ...
                {}
                <a
                  href={`https://${contractData.chain === 1 ? "etherscan.io" : "polygonscan.com"}/token/${contractData.mintContract.address}?a=${data?.DetailsOfANft?.token_id}`}
                  target="_blank"
                ...
                <div>
                  ...
                  <div className="my-3">
                    ...
                    <Popover
                      ...
                      trigger="hover"
                      placement="right"
                      color={bgColor === "dark-grey-bg" ? "#1a1a1a" : "#ffffff"}
