...
const NftDetailsScreen = () => {
  ...
  }, [pageAuction, isTopModalOpen, fetchAuctionData, id, limit, contractData?.chain]);
  return <div className={`${backgroundTheme} pb-2`} style={{
    minHeight: "100vh",
    overflow: "hidden"
  }}>
      <ShowTopNFTPopup isOpen={isTopModalOpen} onRequestClose={() => setIsTopModalOpen(false)} fixedData={fixedData} auctionData={auctionData} name={data?.DetailsOfANft?.name} page={page} setPage={setPage} pageAuction={pageAuction} auctionTotalPages={auctionTotalPages} totalPages={totalPages} setPageAuction={setPageAuction} marketplacecard={true} />
            ...
            lg: 50
              ...
              <Col lg={12} sm={24} md={12} xs={24}>
                ...
                width: "100%"
                  ...
                  <ReactPlayer controls={true} width="100%" height={220} url={data?.DetailsOfANft?.video} />
                </div>
                {}
                <a href={`https://${contractData.chain === 1 ? "etherscan.io" : "polygonscan.com"}/token/${contractData.mintContract.address}?a=${data?.DetailsOfANft?.token_id}`} target="_blank" className={`${textColor2}`} rel="noreferrer">
                  <div style={{
                ...
                <div>
                  <div className="my-3">
                    ...
                    <p className={`${textColor2} m-0 fs-6`}>
                      {data?.DetailsOfANft?.wallet_address && trimWallet(data?.DetailsOfANft?.wallet_address)}
                    </p>
                    {}
                  </div>
                  <div className="my-3">
                  ...
                  <div className="my-3">
                    ...
                    position: "relative"
                          ...
                          <div className="avatar-wrapper">
                            <Avatar size={90} src={data?.DetailsOfANft?.user_id?.profileImg ? `${process.env.REACT_APP_BACKEND_BASE_URL}/${data?.DetailsOfANft?.user?.profileImg}` : null} style={{
                        ...
                        fontSize: "18px",
                        letterSpacing: "0.2px",
                        color: bgColor === "dark-grey-bg" ? "white" : "black"
                      }}>
                        ...
                        padding: "4px 0",
                        color: bgColor === "dark-grey-bg" ? "#b0b0b0" : "#666666"
                      }}>
                              {data?.DetailsOfANft?.user_id?.user_address && trimWallet(data?.DetailsOfANft?.user_id?.user_address)}
                            </p>

                            {data?.DetailsOfANft?.user_id?.bio && <div className="artist-bio-box" style={{
                        width: "100%"
                      }}>
                          ...
                          textAlign: "left",
                          opacity: 0.9,
                          color: bgColor === "dark-grey-bg" ? "#e0e0e0" : "#444444",
                          whiteSpace: "pre-wrap",
                        ...
                        </div>} title={null} trigger="hover" placement="right" color={bgColor === "dark-grey-bg" ? "#1a1a1a" : "#ffffff"} overlayClassName={`artist-popover ${bgColor === "dark-grey-bg" ? "dark-grey-bg-popover" : "bg-white-popover"}`}>
                      <p className={`${textColor2} m-0 fs-6 cursor-pointer`} style={{
