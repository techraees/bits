...
const VideoGallery = () => {
  ...
  const handlePriceChange = async value => {
    ...
    const convertedPrice = await Promise.all(data.map(async val => {
    ...
    overflow: "hidden"
      ...
      <div className="container">
        ...
        <div className="d-flex justify-content-between mt-5 main_filter_parent">
          <div className="d-flex gap-5 main_filter_parent__child_filters_with_categorised">
            ...
            <div className="marketplace-select-field d-flex gap-2 main_filter_parent__select_icons">
              <div className={`marketplace-selct-div ${bgColor} main_filter_parent__select_icons_single`}>
                <Select defaultValue="Category" style={{
                width: 120
              }} className={`main_filter_parent__select_icons_single_sub_child ${textColor == "black" && "light"}`} onChange={handleCategoryChange} options={[{
                value: "Dance",
                label: "Dance"
              }, {
                value: "Emote",
              ...
              <div className={`marketplace-selct-div ${bgColor} main_filter_parent__select_icons_single`}>
                <Select defaultValue="Price" style={{
                width: 120
              }} className={`main_filter_parent__select_icons_single_sub_child ${textColor == "black" && "light"}`} onChange={handlePriceChange} options={[{
                value: "0-10",
                label: "$0-$10"
              }, {
                value: "10-100",
              ...
              <div className={`marketplace-selct-div ${bgColor} main_filter_parent__select_icons_single`}>
                <Select defaultValue="Quantity" style={{
                width: 120
              }} onChange={handleQuantityChange} className={`main_filter_parent__select_icons_single_sub_child ${textColor == "black" && "light"}`} options={[{
                value: "0-10",
                label: "0-10"
              }, {
                value: "10-100",
              ...
              <div className={`marketplace-selct-div ${bgColor} main_filter_parent__select_icons_single`}>
                <Select defaultValue="Ranking" style={{
                width: 120
              }} className={`main_filter_parent__select_icons_single_sub_child ${textColor == "black" && "light"}`} onChange={handleRankingChange} options={[{
                value: "Coming Soon",
                label: "Coming Soon"
              }]} />
              </div>
          ...
          <div className={`grid-wrapper d-flex align-items-center ${bgColor}`} style={{
          width: "fit-content"
        }}>
        ...
        <div className="d-flex gap-2 align-items-center justify-content-end mb-1 my-3 pagination-wrapper">
          <Pagination total={getAllNftsInMarketPlaceAndSupportFilter?.getAllNftsInMarketPlaceAndSupportFilter?.totalItems} pageSize={pageSize} current={currentPage} onChange={handlePageChange} itemRender={itemRender} />
        </div>
        <div className="row my-3  p-4 p-md-0">
          {getAllNftsInMarketPlaceAndSupportFilterLoading ? <CardSkeletal /> : getAllNftsInMarketPlaceAndSupportFilter?.getAllNftsInMarketPlaceAndSupportFilter?.data?.length > 0 ? getAllNftsInMarketPlaceAndSupportFilter?.getAllNftsInMarketPlaceAndSupportFilter?.data?.map((item, i) => {
