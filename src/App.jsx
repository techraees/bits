...
import {ADD_NFT_TO_NFT_MARKET_PLACE,REMOVE_NFT_NFT_MARKET_PLACE} from './gql/mutations'

function App() {
  // const [recordVisit] = useMutation(RECORD_VISIT_MUTATION);
  const [addNftToMarketPlace, { data, loading, error }] = useMutation(ADD_NFT_TO_NFT_MARKET_PLACE);
