...
import { collection, gallery, home2, marketplace, right_arrow, history, plus, setting, transaction_history, selling_history, purchase_history, account_settings, help_center, lock, about } from "./assets";
...
const routes = [{
  ...
  path: "/video-gallery",
  icon: gallery,
  component: <Navigate to={`/marketplace?tab=${ALLOWED_MARKET_PLACE_NFT_TYPE.FIXED_PRICE}`} replace />,
  visible: true,
  isNav: false,
  key: 6
}, {
